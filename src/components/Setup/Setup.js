...
const NextButton = ({ scrollTo, scrollBack, nextText = "Next" }) => {
    const { width } = useWindowDimensions();

    return (
        <View style={{ flexDirection: 'row', marginBottom: 40 }}>
            <Button title={'Back'} type={'outline'} buttonStyle={{ padding: 20, width: (width - 50) / 2, borderRadius: 15 }} onPress={scrollBack} />
